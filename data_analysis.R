...
axis(4, at = -41, labels = expression("Lake isoscape "*delta^{2}*"H (\u2030)"), tick = FALSE, line=3.8)
...
addRasterLegend(d2H.r, side = 4, location = c(-69.6, -69.3, -43.5, -38.5), cex = 1)
axis(4, at = -41, labels = expression("Lake isoscape "*delta^{18}*"O (\u2030)"), tick = FALSE, line=3.8)
lines(bnd, col="dark grey")
...
addRasterLegend(d2H.r, side = 4, location = c(-69.6, -69.3, -43.5, -38.5), cex = 1)
axis(4, at = -41, labels = "Lake isoscape D-excess (\u2030)", tick = FALSE, line=3.8)
lines(bnd, col="dark grey")
